...
// Nikita has 3 real projects (all hosted on GitHub, no live deploys yet),
// cycled through the gallery's 11 fixed display slots.
const FALLBACK_PROJECTS = [
    {
        id: 'ai-recipe-platform-1',
        ...
        description: 'An AI-powered cooking assistant built with Next.js, Strapi 5 CMS, and Google Gemini API for recipe generation and pantry-based ingredient detection, with a freemium subscription model and PDF export.',
        techStack: ['/textures/gallery/reactlogo.webp', '/textures/gallery/jslogo.webp', '/textures/gallery/firebaselogo.webp']
    },
    {
        id: 'movie-recommendation-1',
        title: 'MOVIE RECOMMENDATION SYSTEM',
        front: '/textures/gallery/monetuneprzod.webp',
        painted: '/textures/gallery/monetuneprzod_painted.webp',
        url: 'https://github.com/Nikita-1414',
        description: 'A content-based movie recommendation engine using Python, FastAPI, and Streamlit with TF-IDF vectorization and cosine similarity, integrated with the TMDB REST API for real-time movie data.',
    ...
    },
    {
        ...
        url: 'https://github.com/Nikita-1414',
        description: 'A MERN-based event booking platform with JWT authentication, bcrypt security, OTP email verification, role-based admin controls, and an analytics dashboard.',
        techStack: ['/textures/gallery/reactlogo.webp', '/textures/gallery/jslogo.webp', '/textures/gallery/firebaselogo.webp']
    },
    {
        id: 'ai-recipe-platform-2',
        title: 'AI RECIPE PLATFORM',
...
const PROJECT_COUNT = 11; // 11 unique projects in sequence
const GAP = 2.5;
