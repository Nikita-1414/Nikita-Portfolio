...
/**
 * HeroText Component - Custom styled for Nikita
 */
const HeroText = ({ position = [0, 0.3, 0] }) => {
    ...
    // Letter positions for NIKITA split effect
    const letters = useMemo(() => [
        { char: 'N', baseX: -1.25, splitDir: -2.0 },
        { char: 'I', baseX: -0.75, splitDir: -1.2 },
        { char: 'K', baseX: -0.25, splitDir: -0.4 },
        { char: 'I', baseX: 0.25, splitDir: 0.4 },
        { char: 'T', baseX: 0.75, splitDir: 1.2 },
    ...
    const taglineWords = useMemo(() => [
        ...
        { text: 'UX Designer', baseX: -0.5, splitDir: -0.7 },
        { text: 'AI/ML Enthusiast', baseX: 0.5, splitDir: 0.7 },
        { text: 'Problem Solver', baseX: 1.4, splitDir: 2.0 },
    ], []);
    ...
    useFrame((state, delta) => {
        ...
        // Apply split to each letter of NIKITA
